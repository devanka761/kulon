...
class Notip {
  ...
  run() {
    ...
    audio.emit({ action: "play", type: "ui", src: "phone_notification", options: { id: Date.now().toString() } })
...
export default function notip(data: { a?: string; b?: string; c?: string | number; ic?: string }) {
  // const newData: INotipConfig = Object.assign({}, { a: "", b: "", ic: "bell", c: "1" }, { a: "", b: "", ic: "bell", c: "1" })
