...
export default class Doodles {
  ...
  private el: HTMLDivElement = kel("div", "doodle-pattern parallax")
  ...
  private onPointerMove(): void {
    this.config.root.onpointermove = (e) => {
      ...
      const grid = qutor(".doodle-grid", this.el)
      if (grid) {
